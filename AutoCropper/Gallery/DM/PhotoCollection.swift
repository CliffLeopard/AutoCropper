...
class PhotoCollection: NSObject, ObservableObject {
    ...
    func addImage(_ imageData: Data) async throws {
        ...
        do {
            ...
            debugPrint("Error adding image to photo library: \(error.localizedDescription)")
    ...
    func removeAsset(_ asset: PhotoAsset) async throws {
        ...
        do {
            ...
            debugPrint("Error removing all photos from the album: \(error.localizedDescription)")
